...
function(robotics_setup_dependencies)
    ...
    # OpenCV library (system preferred - Yocto should provide this)
    find_package(OpenCV QUIET COMPONENTS core imgproc imgcodecs videoio)

    if(OpenCV_FOUND)
        # Create imported target for system OpenCV
        ...
        message(WARNING "OpenCV not found - creating dummy target")
        add_library(opencv INTERFACE)
        target_compile_definitions(opencv INTERFACE NO_OPENCV)
